...
function scp_insert()
{
    ...
    if (get_option('scpID')) {
		...
		$sty_script = "<script type=\"text/javascript\"> var headID = document.getElementsByTagName(\"head\")[0]; var newScript = document.createElement('script'); newScript.type = 'text/javascript'; newScript.async = true; newScript.src = '//www.storeya.com/externalscript/couponpop/".htmlspecialchars($secret_key)."?'; headID.appendChild(newScript);</script>";
